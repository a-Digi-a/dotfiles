...
-- 2. Pane Splitting:
--    - LEADER + t: Split the current pane horizontally into two panes.
...
-- - Tab and split indices are zero-based.- Pull in the wezterm API
...
--config.default.prog = { "pwsh.exe" }
config.default_prog = { "pwsh.exe", "-i" }
